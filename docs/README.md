...
这些文档共同构成实现规范。发生冲突时，优先级为：数据安全与安全边界、架构决策、产品需求、界面细节、迭代入口文档。
...
| [08-development-plan.md](08-development-plan.md)                                               | 迭代状态、评审、依赖和实施方式               |
| [09-test-strategy.md](09-test-strategy.md)                                                     | 测试分层、夹具、性能与验收设计               |
| [10-release-quality-gates.md](10-release-quality-gates.md)                                     | 发布等级和阻断条件                           |
| [11-codex-cli-runbook.md](11-codex-cli-runbook.md)                                             | Codex CLI 的逐迭代执行手册                   |
...
| [22-typora-1.13.8-windows-evidence-baseline.md](22-typora-1.13.8-windows-evidence-baseline.md) | Typora 1.13.8 Windows 公开证据与复刻追踪基线 |
| [../iterations/README.md](../iterations/README.md)                                             | M0–M8 入口文档、测试用例、退出报告与证据规则 |

活跃执行规格位于 [`iterations/`](../iterations/README.md)。任何实现迭代都必须引用需求 ID、架构约束和测试 ID。
